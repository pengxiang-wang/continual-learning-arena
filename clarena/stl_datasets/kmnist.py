...
from torchvision.datasets import KMNIST as KMNISTRaw
...
class KMNIST(STLDatasetFromRaw):
    r"""Kuzushiji-MNIST dataset. The [Kuzushiji-MNIST dataset](https://github.com/rois-codh/kmnist) is a collection of Japanese Kuzushiji character images. It consists of 60,000 training and 10,000 test images of Japanese Kuzushiji images (10 classes), each 28x28 grayscale image (similar to MNIST)."""

    original_dataset_python_class: type[Dataset] = KMNISTRaw
    ...
    def prepare_data(self) -> None:
        ...
        KMNISTRaw(root=self.root, train=True, download=True)
        KMNISTRaw(root=self.root, train=False, download=True)
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = KMNISTRaw(
            root=self.root,
            train=True,
