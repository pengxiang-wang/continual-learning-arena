...
from clarena.stl_datasets.raw import SignLanguageMNIST as SignLanguageMNISTRaw

# always get logger for built-in logging in each module
pylogger = logging.getLogger(__name__)


class SignLanguageMNIST(STLDatasetFromRaw):
    r"""Sign Language MNIST dataset. The [Sign Language MNIST dataset](https://www.kaggle.com/datasets/datamunge/sign-language-mnist) is a collection of hand gesture images representing ASL letters (A-Y, excluding J). It consists of 34,627 images of 24 classes, each 28x28 grayscale image."""

    original_dataset_python_class: type[Dataset] = SignLanguageMNISTRaw
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = SignLanguageMNISTRaw(
            root=self.root,
            train=True,
    ...
    def test_dataset(self) -> Dataset:
        ...
        **Returns:**
        ...
        dataset_test = SignLanguageMNISTRaw(
            root=self.root,
            train=False,
