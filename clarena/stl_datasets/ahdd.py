...
from clarena.stl_datasets.raw import (
    ArabicHandwrittenDigits as ArabicHandwrittenDigitsRaw,
)
...
class ArabicHandwrittenDigits(STLDatasetFromRaw):
    r"""Arabic Handwritten Digits dataset. The [Arabic Handwritten Digits dataset](https://www.kaggle.com/datasets/mloey1/ahdd1) is a collection of handwritten Arabic digits (0-9). It consists of 60,000 training and 10,000 test images of handwritten Arabic digits (10 classes), each 28x28 grayscale image (similar to MNIST)."""

    original_dataset_python_class: type[Dataset] = ArabicHandwrittenDigitsRaw
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = ArabicHandwrittenDigitsRaw(
            root=self.root,
            train=True,
    ...
    def test_dataset(self) -> Dataset:
        ...
        **Returns:**
        ...
        """
        dataset_test = ArabicHandwrittenDigitsRaw(
            root=self.root,
            train=False,
