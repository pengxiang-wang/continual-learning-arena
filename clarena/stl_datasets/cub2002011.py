r"""
The submodule in `stl_datasets` for CUB-200-2011 dataset.
"""
...
from clarena.stl_datasets.raw import CUB2002011 as CUB2002011Raw

# always get logger for built-in logging in each module
pylogger = logging.getLogger(__name__)


class CUB2002011(STLDatasetFromRaw):
    r"""CUB-200-2011 dataset. The [CUB (Caltech-UCSD Birds)-200-2011)](https://www.vision.caltech.edu/datasets/cub_200_2011/) is a bird image dataset. It consists of 100,000 training, 10,000 validation, 10,000 test images of 200 bird species (classes), each 64x64 color image."""

    original_dataset_python_class: type[Dataset] = CUB2002011Raw
    ...
    def prepare_data(self) -> None:
        ...
        CUB2002011Raw(root=self.root, train=True, download=True)
        CUB2002011Raw(root=self.root, train=False, download=True)
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = CUB2002011Raw(
            root=self.root,
            train=True,
