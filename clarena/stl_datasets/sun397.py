r"""
The submodule in `stl_datasets` for SUN397 dataset.
"""
...
from torchvision.datasets import SUN397 as SUN397Raw
...
class SUN397(STLDatasetFromRaw):
    r"""SUN397 dataset. The [SUN397 dataset](https://vision.princeton.edu/projects/2010/SUN) is a collection of scene images. It consists of 108,754 images of 397 classes, each color image."""

    original_dataset_python_class: type[Dataset] = SUN397Raw
    ...
    def prepare_data(self) -> None:
        ...
        SUN397Raw(root=self.root, download=True)

        pylogger.debug(
            "The original SUN397 dataset has been downloaded to %s.", self.root
        )
