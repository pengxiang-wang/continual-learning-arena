r"""
The submodule in `stl_datasets` for CIFAR-100 dataset.
"""
...
from torchvision.datasets import CIFAR100 as CIFAR100Raw
...
class CIFAR100(STLDatasetFromRaw):
    r"""CIFAR-100 dataset. The [CIFAR-100 dataset](https://www.cs.toronto.edu/~kriz/cifar.html) is a subset of the [80 million tiny images dataset](https://people.csail.mit.edu/torralba/tinyimages/). It consists of 50,000 training and 10,000 test images of 100 classes, each 32x32 color image."""

    original_dataset_python_class: type[Dataset] = CIFAR100Raw
    ...
    def prepare_data(self) -> None:
        ...
        CIFAR100Raw(root=self.root, train=True, download=True)
        CIFAR100Raw(root=self.root, train=False, download=True)
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = CIFAR100Raw(
            root=self.root,
            train=True,
