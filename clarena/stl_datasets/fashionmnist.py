r"""
The submodule in `stl_datasets` for Fashion-MNIST dataset.
"""
...
from torchvision.datasets import FashionMNIST as FashionMNISTRaw
...
class FashionMNIST(STLDatasetFromRaw):
    r"""Fashion-MNIST dataset. The [Fashion-MNIST dataset](https://github.com/zalandoresearch/fashion-mnist) is a collection of fashion images. It consists of 60,000 training and 10,000 test images of 10 types of clothing (classes), each 28x28 grayscale image (similar to MNIST)."""

    original_dataset_python_class: type[Dataset] = FashionMNISTRaw
    ...
    def prepare_data(self) -> None:
        ...
        FashionMNISTRaw(root=self.root, train=True, download=True)
        FashionMNISTRaw(root=self.root, train=False, download=True)
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = FashionMNISTRaw(
            root=self.root,
            train=True,
