r"""
The submodule in `stl_datasets` for Caltech 256 dataset.
"""
...
from torchvision.datasets import Caltech256 as Caltech256Raw
...
class Caltech256(STLDatasetFromRaw):
    r"""Caltech 256 dataset. The [Caltech 256 dataset](https://data.caltech.edu/records/nyy15-4j048) is a collection of pictures of objects. It consists of 30,607 images of 256 classes, each color image."""

    original_dataset_python_class: type[Dataset] = Caltech256Raw
    ...
    def prepare_data(self) -> None:
        r"""Download the original Caltech 256 dataset if haven't."""

        Caltech256Raw(root=self.root, download=True)

        pylogger.debug(
            "The original Caltech 256 dataset has been downloaded to %s.",
            self.root,
        )
