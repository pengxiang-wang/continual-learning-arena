        ...
        if self.task_id == 1:
            for layer_name in self.backbone.weighted_layer_names:
                ...
                self.summative_mask_for_previous_tasks[layer_name] = torch.zeros(
                    ...
                    self.device
                )  # the summative mask $\mathrm{M}^{<t,\text{sum}}$ is initialised as zeros mask for $t = 1$. See equation (7) in chapter 3.1 in [AdaHAT paper](https://link.springer.com/chapter/10.1007/978-3-031-70352-2_9).
