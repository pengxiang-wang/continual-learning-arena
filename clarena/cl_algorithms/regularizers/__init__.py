...
- [**A Beginners' Guide to Continual Learning (Regularization-based Approaches)**](https://pengxiang-wang.com/posts/continual-learning-beginners-guide#sec-regularization-based-approaches)
