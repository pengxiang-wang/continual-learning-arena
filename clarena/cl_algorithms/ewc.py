...
class EWC(Finetuning):
    ...
    def __init__(
        ...
        **Args:**
        ...
        # set manual optimisation because we need to access gradients to calculate the fisher information in the training step
    ...
    def on_train_start(self) -> None:
        r"""Initialise the parameter importance and num of data counter."""
