r"""The submodule in `heads` for TIL heads."""
...
class HeadsTIL(nn.Module):
    ...
    def __init__(self, input_dim: int) -> None:
        ...
        **Args:**
        ...
        self.head_t: nn.Linear | None = None
        r"""The output head for the current task. It is created when the task arrives and stored in `self.heads`."""
