...
class PermutedKMNIST(CLPermutedDataset):
    r"""Permuted Kuzushiji-MNIST dataset. The [Kuzushiji-MNIST dataset](https://github.com/rois-codh/kmnist) is a collection of Japanese Kuzushiji character images. It consists of 60,000 training and 10,000 test images of Japanese Kuzushiji images (10 classes), each 28x28 grayscale image (similar to MNIST)."""
