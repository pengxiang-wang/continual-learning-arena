r"""
The submodule in `cl_datasets` for Permuted Kuzushiji-MNIST dataset.
"""

__all__ = ["PermutedKMNIST"]
...
class PermutedKMNIST(CLPermutedDataset):
    r"""Permuted Kuzushiji-MNIST dataset. The [original Kuzushiji-MNIST dataset](https://github.com/rois-codh/kmnist) is a collection of Japanese Kuzushiji character images. It consists of 70,000 28x28 grayscale images in 10 classes, with 7000 images per class. There are 60,000 training examples and 10,000 test examples."""

    original_dataset_python_class: type[Dataset] = KMNIST
    ...
    def __init__(
        ...
        r"""Initialise the Permuted Kuzushiji-MNIST dataset object providing the root where data files live.

        **Args:**
        - **root** (`str`): the root directory where the original Kuzushiji-MNIST data 'KMNIST/' live.
