...
from clarena.stl_datasets.raw import ArabicHandwrittenDigits
...
class PermutedArabicHandwrittenDigits(CLPermutedDataset):
    r"""Permuted Arabic Handwritten Digits dataset. The [Arabic Handwritten Digits dataset](https://www.kaggle.com/datasets/mloey1/ahdd1) is a collection of handwritten Arabic digits (0-9). It consists of 60,000 training and 10,000 test images of handwritten Arabic digits (10 classes), each 28x28 grayscale image (similar to MNIST)."""
