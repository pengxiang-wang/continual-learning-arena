...
__all__ = ["PermutedArabicHandwrittenDigits"]
...
from clarena.cl_datasets.base import CLClassMapping
from clarena.cl_datasets.original import ArabicHandwrittenDigits

# always get logger for built-in logging in each module
pylogger = logging.getLogger(__name__)


class PermutedArabicHandwrittenDigits(CLPermutedDataset):
    r"""Permuted Arabic Handwritten Digits dataset. The [Arabic Handwritten Digits dataset](https://www.kaggle.com/datasets/mloey1/ahdd1) is a collection of handwritten Arabic digits (0-9). The dataset contains 60,000 training and 10,000 testing samples of handwritten Arabic digits (0-9), each 28x28 grayscale image."""

    original_dataset_python_class: type[Dataset] = ArabicHandwrittenDigits
    ...
    def __init__(
        ...
        r"""Initialise the Permuted Arabic Handwritten Digits dataset object providing the root where data files live.
    ...
    def prepare_data(self) -> None:
        r"""Download the original Arabic Handwritten Digits dataset if haven't. Because the original dataset is published on Kaggle, we need to download it manually. This function will not download the original dataset automatically."""
        pass
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = ArabicHandwrittenDigits(
            root=self.root_t,
            train=True,
    ...
    def test_dataset(self) -> Dataset:
        ...
        **Returns:**
        ...
        """
        dataset_test = ArabicHandwrittenDigits(
            root=self.root_t,
            train=False,
