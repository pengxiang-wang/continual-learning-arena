...
class PermutedFGVCAircraft(CLPermutedDataset):
    r"""Permuted FGVC-Aircraft dataset. The [original FGVC-Aircraft dataset](https://www.robots.ox.ac.uk/~vgg/data/fgvc-aircraft/) is a collection of aircraft images. It consists of 10,000 images."""
    ...
    def __init__(
        ...
        r"""Initialise the Permuted FGVC-Aircraft dataset object providing the root where data files live.
