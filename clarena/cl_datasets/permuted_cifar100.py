...
class PermutedCIFAR100(CLPermutedDataset):
    r"""Permuted CIFAR-100 dataset. The [CIFAR-100 dataset](https://www.cs.toronto.edu/~kriz/cifar.html) is a subset of the [80 million tiny images dataset](https://people.csail.mit.edu/torralba/tinyimages/). It consists of 50,000 training and 10,000 test images of 100 classes, each 32x32 color image."""
