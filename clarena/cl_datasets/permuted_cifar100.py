r"""
The submodule in `cl_datasets` for Permuted CIFAR-100 dataset.
"""

__all__ = ["PermutedCIFAR100"]
...
class PermutedCIFAR100(CLPermutedDataset):
    r"""Permuted CIFAR-100 dataset. The [original CIFAR-10 dataset](https://www.cs.toronto.edu/~kriz/cifar.html) is a subset of the 80 million tiny images dataset. It consists of 60,000 32x32 colour images in 100 classes, with 600 images per class. There are 50,000 training examples and 10,000 test examples."""

    original_dataset_python_class: type[Dataset] = CIFAR100
    ...
    def __init__(
        ...
        r"""Initialise the Permuted CIFAR-100 dataset object providing the root where data files live.
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = CIFAR100(
            root=self.root_t,
            train=True,
