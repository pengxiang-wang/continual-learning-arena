...
from clarena.stl_datasets.raw import KannadaMNIST

# always get logger for built-in logging in each module
pylogger = logging.getLogger(__name__)


class PermutedKannadaMNIST(CLPermutedDataset):
    r"""Permuted Kannada-MNIST dataset. The [Kannada-MNIST dataset](https://github.com/vinayprabhu/Kannada_MNIST) is a collection of handwritten Kannada digits (0-9). It consists of 60,000 training and 10,000 test images of handwritten Kannada digits (10 classes), each 28x28 grayscale image (similar to MNIST)."""

    original_dataset_python_class: type[Dataset] = KannadaMNIST
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = KannadaMNIST(
            root=self.root_t,
            train=True,
