...
class CLRotatedDataset(CLDataset):
    r"""The base class of continual learning datasets constructed as rotations of an original dataset."""
    ...
    def __init__(
        ...
        **Args:**
        ...
        CLRotatedDataset.sanity_check(self)
