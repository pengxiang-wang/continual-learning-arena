...
class PermutedStanfordCars(CLPermutedDataset):
    r"""Permuted Stanford Cars dataset. The [Stanford Cars dataset](https://pytorch.org/vision/stable/generated/torchvision.datasets.StanfordCars.html#torchvision.datasets.StanfordCars/) is a collection of car images. It consists of 16,185 images in 196 classes, each color image."""
