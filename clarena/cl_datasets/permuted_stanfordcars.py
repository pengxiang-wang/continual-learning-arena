r"""
The submodule in `cl_datasets` for Permuted Stanford Cars dataset.
"""

__all__ = ["PermutedStanfordCars"]
...
class PermutedStanfordCars(CLPermutedDataset):
    r"""Permuted Stanford Cars dataset. The [original Stanford Cars dataset](https://pytorch.org/vision/stable/generated/torchvision.datasets.StanfordCars.html#torchvision.datasets.StanfordCars/) is a collection of 196 classes of cars. It consists of 16,185 images in 196 classes."""

    original_dataset_python_class: type[Dataset] = StanfordCars
    ...
    def __init__(
        ...
        r"""Initialise the Permuted Stanford Cars dataset object providing the root where data files live.
    ...
    def prepare_data(self) -> None:
        ...
        if self.task_id == 1:
            ...
            StanfordCars(root=self.root_t, split="train", download=True)
            StanfordCars(root=self.root_t, split="test", download=True)
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = StanfordCars(
            root=self.root_t,
            split="train",
