r"""
The submodule in `cl_datasets` for Permuted EuroSAT dataset.
"""

__all__ = ["PermutedEuroSAT"]
...
class PermutedEuroSAT(CLPermutedDataset):
    r"""Permuted EuroSAT dataset. The [original EuroSAT dataset](https://github.com/phelber/eurosat) is a collection of satellite images of lands. It consists of 27,000 images in 10 classes, with 2,700 images per class."""

    original_dataset_python_class: type[Dataset] = EuroSAT
    ...
    def prepare_data(self) -> None:
        ...
        EuroSAT(root=self.root_t, download=True)

        pylogger.debug(
            "The original EuroSAT dataset has been downloaded to %s.", self.root_t
        )
