...
class PermutedEuroSAT(CLPermutedDataset):
    r"""Permuted EuroSAT dataset. The [EuroSAT dataset](https://github.com/phelber/eurosat) is a collection of satellite images of lands. It consists of 27,000 images of 10 classes, each 64x64 color image."""
