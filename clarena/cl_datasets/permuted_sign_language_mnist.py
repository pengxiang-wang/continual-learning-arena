r"""
The submodule in `cl_datasets` for Permuted Sign Language MNIST dataset.
"""

__all__ = ["PermutedSignLanguageMNIST"]
...
from clarena.cl_datasets.original import SignLanguageMNIST

# always get logger for built-in logging in each module
pylogger = logging.getLogger(__name__)


class PermutedSignLanguageMNIST(CLPermutedDataset):
    r"""Permuted Sign Language MNIST dataset. The [original Sign Language MNIST dataset](https://www.kaggle.com/datasets/datamunge/sign-language-mnist) is a collection of hand gesture images representing ASL letters (A-Y, excluding J). It consists of 34,627 28x28 grayscale images in 24 classes."""

    original_dataset_python_class: type[Dataset] = SignLanguageMNIST
    ...
    def __init__(
        ...
        r"""Initialise the Permuted Sign Language MNIST dataset object providing the root where data files live.
    ...
    def prepare_data(self) -> None:
        r"""Download the original Sign Language MNIST dataset if haven't. Because the original dataset is published on Kaggle, we need to download it manually. This function will not download the original dataset automatically."""
        pass
    ...
    def train_and_val_dataset(self) -> tuple[Dataset, Dataset]:
        ...
        **Returns:**
        ...
        """
        dataset_train_and_val = SignLanguageMNIST(
            root=self.root_t,
            train=True,
