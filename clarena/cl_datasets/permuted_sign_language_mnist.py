...
from clarena.stl_datasets.raw import SignLanguageMNIST
...
class PermutedSignLanguageMNIST(CLPermutedDataset):
    r"""Permuted Sign Language MNIST dataset. The [Sign Language MNIST dataset](https://www.kaggle.com/datasets/datamunge/sign-language-mnist) is a collection of hand gesture images representing ASL letters (A-Y, excluding J). It consists of 34,627 images of 24 classes, each 28x28 grayscale image."""
