...
class PermutedUSPS(CLPermutedDataset):
    r"""Permuted USPS dataset. The [USPS dataset](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/multiclass.html#usps) is a collection of handwritten digits. It consists of 9,298 handwritten digit images (10 classes), each 16x16 grayscale image."""
