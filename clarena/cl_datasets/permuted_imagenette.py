...
class PermutedImagenette(CLPermutedDataset):
    r"""Permuted Imagenette dataset. The [Imagenette dataset](https://github.com/fastai/imagenette) is a subset of 10 easily classified classes from [Imagenet](https://www.image-net.org). It provides full sizes (as Imagenet), and resized 320x320 and 160x160. We support all of them in Permuted Imagenette."""
