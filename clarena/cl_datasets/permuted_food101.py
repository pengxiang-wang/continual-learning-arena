...
class PermutedFood101(CLPermutedDataset):
    r"""Permuted Food-101 dataset. The [Food-101 dataset](https://data.vision.ee.ethz.ch/cvl/datasets_extra/food-101/) is a collection of food images. It consists of 101,000 images of 101 classes, each color image."""
