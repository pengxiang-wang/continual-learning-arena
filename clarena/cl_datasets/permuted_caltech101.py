...
class PermutedCaltech101(CLPermutedDataset):
    r"""Permuted Caltech 101 dataset. The [Caltech 101 dataset](https://data.caltech.edu/records/mzrjq-6wc02) is a collection of pictures of objects. It consists of 9,146 images of 101 classes, each color image."""
