...
class PermutedFER2013(CLPermutedDataset):
    r"""Permuted FER2013 dataset. The [FER2013 dataset](https://www.sciencedirect.com/science/article/abs/pii/S0893608014002159) is a collection of facial expression images. It consists of 35,887 images of 7 facial expressions (classes), each 48x48 grayscale image."""
