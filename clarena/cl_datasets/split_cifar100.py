...
class SplitCIFAR100(CLSplitDataset):
    r"""Split CIFAR-100 dataset. The [original CIFAR-100 dataset](https://www.cs.toronto.edu/~kriz/cifar.html) is a subset of the 80 million tiny images dataset. It consists of 60,000 32x32 colour images in 100 classes, with 600 images per class. There are 50,000 training examples and 10,000 test examples."""
    ...
    def __init__(
        ...
        r"""Initialise the Split CIFAR-100 dataset object providing the root where data files live.
    ...
    def get_subset_of_classes(self, dataset: Dataset) -> Dataset:
        ...
        **Returns:**
        ...
        dataset.target_transform = CLClassMapping(self.cl_class_map_t)
