r"""
The submodule in `cl_datasets` for Permuted Caltech 256 dataset.
"""

__all__ = ["PermutedCaltech256"]
...
class PermutedCaltech256(CLPermutedDataset):
    r"""Permuted Caltech 256 dataset. The [original Caltech 256 dataset](http://yann.lecun.com/exdb/mnist/) is a collection of pictures of objects. It consists of 30,607 images in 256 classes (correspond to 256 objects)."""

    original_dataset_python_class: type[Dataset] = Caltech256
    ...
    def prepare_data(self) -> None:
        ...
        Caltech256(root=self.root_t, download=True)
