...
class EMNISTByClass(EMNIST):
    ...
    def __init__(
        ...
        r"""Initialise the EMNIST ByClass dataset.
...
class EMNISTByMerge(EMNIST):
    ...
    def __init__(
        ...
        r"""Initialise the EMNIST ByMerge dataset.
...
class EMNISTBalanced(EMNIST):
    ...
    def __init__(
        ...
        r"""Initialise the EMNIST Balanced dataset.
...
class EMNISTLetters(EMNIST):
    ...
    def __init__(
        ...
        r"""Initialise the EMNIST Letters dataset.
...
class EMNISTDigits(EMNIST):
    ...
    def __init__(
        ...
        r"""Initialise the EMNIST Digits dataset.
