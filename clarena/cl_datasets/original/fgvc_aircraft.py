...
class FGVCAircraftVariant(FGVCAircraft):
    ...
    def __init__(
        ...
        r"""Initialise the FGVC-Aircraft dataset annotated by variant.
...
class FGVCAircraftFamily(FGVCAircraft):
    ...
    def __init__(
        ...
        r"""Initialise the FGVC-Aircraft dataset annotated by family.
...
class FGVCAircraftManufacturer(FGVCAircraft):
    ...
    def __init__(
        ...
        r"""Initialise the FGVC-Aircraft dataset annotated by manufacturer.
