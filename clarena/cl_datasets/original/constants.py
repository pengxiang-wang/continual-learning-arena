...
DATASET_CONSTANTS_MAPPING: dict[type[Dataset], type[DatasetConstants]] = {
    ...
    original.FGVCAircraftManufacturer: FGVCAircraftManufacturerConstants,
    original.FaceScrub10: FaceScrub10Constants,
    ...
    original.Linnaeus5_256: Linnaeus5_256Constants,
}
