...
class PermutedSVHN(CLPermutedDataset):
    r"""Permuted SVHN dataset. The [SVHN dataset](http://ufldl.stanford.edu/housenumbers/) is a collection of street view house number images. It consists 73,257 training and 26,032 test images of 10 classes, each 32x32 color image."""
