...
class PermutedFashionMNIST(CLPermutedDataset):
    r"""Permuted Fashion-MNIST dataset. The [Fashion-MNIST dataset](https://github.com/zalandoresearch/fashion-mnist) is a collection of fashion images. It consists of 60,000 training and 10,000 test images of 10 types of clothing (classes), each 28x28 grayscale image (similar to MNIST)."""
    ...
    def prepare_data(self) -> None:
        ...
        pylogger.debug(
            "The original Fashion-MNIST dataset has been downloaded to %s.",
            self.root_t,
        )
