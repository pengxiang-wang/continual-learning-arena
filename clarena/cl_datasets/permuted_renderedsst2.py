...
class PermutedRenderedSST2(CLPermutedDataset):
    r"""Permuted Rendered SST2 dataset. The [Rendered SST2 dataset](https://github.com/openai/CLIP/blob/main/data/rendered-sst2.md) is a collection of optical character recognition images. It consists of 9,613 images in 2 classes (positive and negative sentiment), each 448x448 color image."""
