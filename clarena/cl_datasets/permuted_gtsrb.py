...
class PermutedGTSRB(CLPermutedDataset):
    r"""Permuted GTSRB dataset. The [GTSRB dataset](http://yann.lecun.com/exdb/mnist/) is a collection of traffic sign images. It consists of 51,839 images of 43 different traffic signs (classes), each color image."""
