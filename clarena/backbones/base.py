    ...
    def __init__(
        ...
        **Args:**
        ...
        if not disable_unlearning:
            ...
            self.backup_task_ids: list[int]
            r"""The task IDs that need to have backup backbones at current task `self.task_id`."""
