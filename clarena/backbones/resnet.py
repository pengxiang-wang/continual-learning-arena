r"""
The submodule in `backbones` for ResNet backbone network. It includes multiple versions of ResNet, including the basic ResNet, the continual learning ResNet, the [HAT](http://proceedings.mlr.press/v80/serra18a) masked ResNet, and the AmnesiacHAT masked ResNet.
"""
